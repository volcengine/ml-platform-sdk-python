...
deploy: build
	aws s3 cp dist/volcengine_ml_platform-1.0.3-py3-none-any.whl s3://ml-platform-public-examples-cn-beijing/python_sdk_installer/volcengine_ml_platform-1.0.3-py3-none-any.whl --endpoint-url=http://tos-s3-cn-beijing.volces.com
