...
sync_to_github:
	cp -r .gitignore .pre-commit-config.yaml LICENSE Makefile README.md dev-requirements.txt docs pytest.ini samples scripts setup.cfg setup.py volcengine_ml_platform tests  ../mlplatform-sdk-python/
