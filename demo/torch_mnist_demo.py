...
region = 'cn-beijing'
tos_source = "tos://mnist-demo-do-not-delete/mnist_training_set.manifest"
...
def main():
    ...
    train_kwargs = {'batch_size': args.batch_size, 'num_workers': 16}
    test_kwargs = {'batch_size': args.test_batch_size, 'num_workers': 16}
    if use_cuda:
        cuda_kwargs = {'num_workers': 16, 'pin_memory': True, 'shuffle': True}
