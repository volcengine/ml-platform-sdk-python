...
_C.DATA.DATA_PATH = "s3://ml-platform-public-examples/flower-classification/photos/"
# Dataset name
...
_C.MODEL.RESUME = "./"
_C.MODEL.LOAD_CHECKPOINT = 0
# Number of classes, overwritten in data preparation
_C.MODEL.LOAD_PRETRAINED = 0
_C.MODEL.NUM_CLASSES = 104
# Dropout rate
...
def update_config(config, args):
    ...
    if args.resume:
        config.MODEL.LOAD_CHECKPOINT = 1
    ...
    if args.load_pretrained:
        config.MODEL.LOAD_PRETRAINED = 1
