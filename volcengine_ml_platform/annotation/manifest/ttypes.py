...
class Data:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'ImageURL', None, None, ), # 1
    (2, TType.STRING, 'VideoURL', None, None, ), # 2
    (3, TType.STRING, 'TextURL', None, None, ), # 3
    (4, TType.STRING, 'FilePath', None, None, ), # 4
  )

  def __init__(self, ImageURL=None, VideoURL=None, TextURL=None, FilePath=None,):
...
class TextSelector:
  ...
  def __init__(self, Pos=None, Len=None,):
    self.Pos = Pos
    self.Len = Len
...
class AnnotationData:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'Options', (TType.STRING,None), None, ), # 2
    (3, TType.STRING, 'Label', None, None, ), # 3
    (4, TType.LIST, 'Labels', (TType.STRING,None), None, ), # 4
  )

  def __init__(self, Type=None, Options=None, Label=None, Labels=None,):
    self.Type = Type
...
class AnnotationResult:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'Bbox', (TType.DOUBLE,None), None, ), # 1
    (2, TType.LIST, 'Segmentation', (TType.LIST,(TType.DOUBLE,None)), None, ), # 2
    (3, TType.STRUCT, 'Text', (TextSelector, TextSelector.thrift_spec), None, ), # 3
    (4, TType.LIST, 'Data', (TType.STRUCT,(AnnotationData, AnnotationData.thrift_spec)), None, ), # 4
  )

  def __init__(self, Bbox=None, Segmentation=None, Text=None, Data=None,):
    self.Bbox = Bbox
...
class Annotation:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'Result', (TType.STRUCT,(AnnotationResult, AnnotationResult.thrift_spec)), None, ), # 3
    (4, TType.I32, 'Status', None, None, ), # 4
  )

  def __init__(self, Type=None, ItemID=None, Result=None, Status=None,):
    self.Type = Type
    self.ItemID = ItemID
    self.Result = Result
    self.Status = Status
...
class ImagePayload:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'TOSURL', None, None, ), # 1
    (2, TType.STRING, 'MimeType', None, None, ), # 2
    (3, TType.STRING, 'ContentURL', None, None, ), # 3
    (4, TType.STRING, 'ThumbnailURL', None, None, ), # 4
    (5, TType.STRUCT, 'Resolution', (Resolution, Resolution.thrift_spec), None, ), # 5
  )

  def __init__(self, TOSURL=None, MimeType=None, ContentURL=None, ThumbnailURL=None, Resolution=None,):
    self.TOSURL = TOSURL
  ...
  def validate(self):
    if self.TOSURL is None:
      raise TProtocol.TProtocolException(message='Required field TOSURL is unset!')
...
class VideoPayload:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'ContentURL', None, None, ), # 3
    (4, TType.STRING, 'ThumbnailURL', None, None, ), # 4
    (5, TType.DOUBLE, 'duration', None, None, ), # 5
    (6, TType.STRUCT, 'Resolution', (Resolution, Resolution.thrift_spec), None, ), # 6
  )

  def __init__(self, TOSURL=None, MimeType=None, ContentURL=None, ThumbnailURL=None, duration=None, Resolution=None,):
    self.TOSURL = TOSURL
    self.MimeType = MimeType
    self.ContentURL = ContentURL
    self.ThumbnailURL = ThumbnailURL
...
class TextPayload:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'TOSURL', None, None, ), # 1
    (2, TType.STRING, 'TrucatedContent', None, None, ), # 2
  )

  def __init__(self, TOSURL=None, TrucatedContent=None,):
    self.TOSURL = TOSURL
  ...
  def validate(self):
    ...
    if self.TrucatedContent is None:
      raise TProtocol.TProtocolException(message='Required field TrucatedContent is unset!')
    return
...
class Payload:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'Image', (ImagePayload, ImagePayload.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'Video', (VideoPayload, VideoPayload.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'Text', (TextPayload, TextPayload.thrift_spec), None, ), # 3
  )

  def __init__(self, Image=None, Video=None, Text=None,):
    self.Image = Image
    self.Video = Video
    self.Text = Text
...
class FileLine:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'Annotation', (Annotation, Annotation.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'Payload', (Payload, Payload.thrift_spec), None, ), # 3
  )

  def __init__(self, Data=None, Annotation=None, Payload=None,):
    self.Data = Data
