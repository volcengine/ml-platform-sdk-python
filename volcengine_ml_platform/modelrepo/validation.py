    ...
    'properties': {
        ...
        'Dtype': {
            'type':
                'string',
            'enum': [
                'FP32', 'FP16', 'INT8', 'INT16', 'INT32', 'INT64', 'UINT8',
                'UINT16', 'UINT32', 'UINT64', 'FP64', 'STRING'
            ],
        },
    },
    ...
    'properties': {
        'MetricsType': {
            'type':
                'string',
            'enum': [
                'ImageClassification', 'TextClassification',
                'TabularClassification', 'TabularRegression', 'Perf'
            ],
        },
        'Params': {
            'type': 'string'
